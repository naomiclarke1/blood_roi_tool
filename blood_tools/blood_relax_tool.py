...
class MainWindow(QtGui.QWidget):
    ...
    def init_gui(self):
        ...
        self.button_load = QtGui.QPushButton(
        ...
        self.roi_area_label = QtGui.QLabel(
